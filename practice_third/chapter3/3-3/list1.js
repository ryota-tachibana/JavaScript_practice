//3-16 aryya
var ary1 = ['Tanama', 'Ichiro', 'Ota', 'Hiroshi', 'Saito','Sato'];
...
console.log(ary1.splice(1, 2, 'Kai', 'Yamada'));
console.log(ary1);
...
console.log(ary1.unshift('Fujita', 'Kuge'));
...
//3-19 aryya_splice
var data = ['Suzuki', 'Takae', 'Ota', 'Hio', 'Sato'];

console.log(data.splice(3, 2, 'Yamada', 'Suziki'));
