//3-33 date
var dat = new Date(2019, 10, 29, 12, 37, 15, 999);
...
console.log(Date.parse('2014/10/15'));
console.log(Date.UTC(2016, 10, 5));
...
//3-35 add_last
var dat = new Date(2011, 24, 25, 11, 40);
