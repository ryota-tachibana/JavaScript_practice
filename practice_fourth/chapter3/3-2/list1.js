//3-3 string
var str1 = 'にわにわにわにわとりがいる';

console.log(str1.indexOf('にわ'));
console.log(str1.lastIndexOf('にわ'));
console.log(str1.indexOf('にわ',2));
console.log(str1.lastIndexOf('わ',4));
console.log(str1.indexOf('ga'));
...
console.log(str2.substring(1, 8));
